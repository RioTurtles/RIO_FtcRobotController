...
@TeleOp (name="tommyisOnBot")

public class Project4 extends LinearOpMode
{
        ...
        while (opModeIsActive()) {
           ...
           */
            ...
            if (stage==1){
                if(!ground){
                    clawDown=false;
                    if ((((robot.lHorz.getCurrentPosition()<500)||(robot.lHorz.getCurrentPosition()<1800&&robot.lHorz.getCurrentPosition()>1000))&&(toggleTimer>5))&&(!loaded)){
                        robot.setArm(0.85);
            ...
            if(!farming){
                if (gamepad1.left_bumper){
                    ...
                    clawDown = true;
                    if((toggleTimer2>3)&&(robot.lHorz.getCurrentPosition()<2000)){
            ...
            if(gamepad1.touchpad&&toggleTimer3>20){
