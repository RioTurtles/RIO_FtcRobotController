...
@Autonomous (name="auton_lefthigh")
@Config

public class Auton_lefthigh extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        TrajectorySequence untitled0 = drive.trajectorySequenceBuilder(new Pose2d(-34.00, -3.00, Math.toRadians(14.00)))
                .lineToSplineHeading(new Pose2d(-32.00, -62.00, Math.toRadians(90.00)))
                .addTemporalMarker(1,() -> {
