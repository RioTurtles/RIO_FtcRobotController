...
@Autonomous (name="jerry2_buffed_average")

public class Auton2_Copy2 extends LinearOpMode {
...
//double backOrgin = robot.backDis.getDistance(DistanceUnit.CM);
        ...
        while (opModeIsActive()) {
            ...
            pivot = (targetDirection - heading)*1.5;
            ...
            if (autonStage ==0){ //moving right
                direction_y = (-2000-yPos)*0.0004*0;//put distance code here
                direction_x = (55000-xPos)*moveVar;
                targetDirection = 0;
