...
@Autonomous (name="auton_rightmid")
@Config

public class Auton_rightmid extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        TrajectorySequence untitled0 = drive.trajectorySequenceBuilder(new Pose2d(-30.17, 69.49, Math.toRadians(270.00)))
                .lineToSplineHeading(new Pose2d(-32, 25, Math.toRadians(14)))
                .addTemporalMarker(1,() -> {
        ...
        while (opModeIsActive()) {
            ...
            Trajectory stay = drive.trajectoryBuilder(myPose)
                    .lineToLinearHeading(new Pose2d(-32, 25, Math.toRadians(14)))
                    .build();
